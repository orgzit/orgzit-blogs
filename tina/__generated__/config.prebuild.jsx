    ...
    collections: [
      {
        ...
        ui: {
          filename: {
            readonly: false,
            slugify: (values) => values?.slug ?? values?.title?.toLowerCase().replace(/[^a-z0-9]+/g, "-") ?? "new-post"
          }
        },
        fields: [
          { type: "boolean", name: "draft", label: "\u{1F512} Draft (hidden from site)", description: "Turn OFF to publish live" },
          ...
          { type: "image", name: "featuredImage", label: "Featured Image", description: "Upload at 1200\xD7675px (16:9)" },
          ...
          { type: "image", name: "ogImage", label: "Social Share Image", description: "1200\xD7630px" },
