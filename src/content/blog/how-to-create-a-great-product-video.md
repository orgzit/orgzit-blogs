---
title: "There Is Insanity In Creating A Sane Product Video"
slug: "how-to-create-a-great-product-video"
date: "2017-07-11"
...
**_Content Marketing is gradually becoming the elephant in the room_**
...
What triggered this seemingly transient feeling was a skeptical yet insightful post by Dave Morgan on [mediapost](https://www.mediapost.com/publications/article/295831/why-are-marketers-losing-confidence-in-their-abili.html).
...
I am not sure how to answer the former but _certain that “Google” is the answer for the latter_.
...
-   Publish (value adding) articles on [medium](https://medium.com/orgzit)
-   Participate in inbound discussions
-   Start a ‘Review Startup’ thread in [Hacker News](https://news.ycombinator.com/item?id=14163859)
-   Answer industry specific questions on [Quora](https://www.quora.com/profile/Orgzit)
-   Create customized images at [imgflip](https://imgflip.com/).
-   Submit blog links to zest.is, Growth Hackers and [Digg](https://digg.com/)
...
_Product + Video = Maximum People Reach_

_**Key Takeaway** – Marketing with words alone can only get you so far. Create content that not only adds value to the user but resonates within the reader._

---

## The Making

My days in Orgzit have been more organized than the ones without it. So it didn’t come to me as a surprise when [Nitin](https://www.linkedin.com/in/nitinv8/), co-founder of Orgzit, told me to follow a process to go ahead with the video. I had seen it work, and I knew it would work just the same this time too.

**_Organize (Gather Your Thoughts)_**

**_#Step 1 – Create a Storyboard which answers these two primary questions:_**
...
_**Key Takeaway**: Your storyboard is like the outline that lays the foundation and becomes your guide for the video script. Essentially, it is the raw version of your Video Script._

**_#Step 2 – Write a Video Script:_**

_Your video script is a word-to-word breakdown of the storyboard that you have created. It is more refined than the storyboard and contains the pitch for your voice over._
...
(Note – Our [meetings at Orgzit](https://www.linkedin.com/pulse/game-changing-insights-how-meetings-can-made-more-productive-verma) are amazingly well timed.)

_**Key Takeaway**: Video Script will need multiple revisions. Take a deep breath every time you send that paper ball rolling into the dustbin._

**_Collaborate (Share your thoughts with friends)_**

**_#Step 3 – Record the Audio:_**
...
**_Note_**_: If you don’t want to burn a hole in your pockets by going to a recording studio or getting a professional voice over done, I will suggest that you use this software called_ _Audacity__. Nitin, a DIY fan, found his nephew fiddling with this software while trying to merge two songs for a birthday party. And it has an amazingly simple user interface and functions which work great for non tech-savvy people._

_Before noise removal:_

_After Noise Removal:_

_Here’s the only thing you need to do once you have recorded your audio using Audacity to remove the background noise:_

[Video: https://youtube.com/watch?v=_wlsUuzZyzk]

You can save this file in MP3 or any other format of your choice to make things easier. Wasn’t that easy?

I asked [Pavan](https://www.linkedin.com/in/pavanv0/), CTO and co-founder of Orgzit, for any changes and got a high five instead. Like I said, it’s not a one man job.

_**Key Takeaway**: You will need to collaborate with your team members at each step and share notes to refine the quality of the script and audio._

**_#Step 4 – Create the Video:_**
...
I suggest that [Powtoons](https://www.powtoon.com/) gives you value for money and has a number of business icons and funky characters which will cover your video making needs – right from showing a tattooed girl to a businessman.
...
_**Key Takeaway**: Your video is the window that you product needs to reach the extended market space. You better make it worth the watch._

---

## Post Video

**_Analyze (Track Your Thoughts)_**
...
-   Promote the video on channels ideal for your product and target a customer base based on chosen demographics and [psychographics](https://blog.capterra.com/psychographic-data-in-b2b-marketing/))
...
‘_Surely hope isn’t a strategy, but the ability to recognize leads and subtly introduce the product to them adds weight to a marketer’s so-called hope and pushes him towards forming a strategy_’
...
\*This article was originally posted by Kartik Dulloo on [medium](https://medium.com/orgzit/there-is-insanity-in-creating-a-sane-product-video-fb670900e76f) on May 1st, 2017.
